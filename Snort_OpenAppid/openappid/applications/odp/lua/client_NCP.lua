...
gPatterns = {
	pattern1 = { "\068\109\100\084\000\000\000", 0, gSfAppIdNcp}, --common header
	pattern2 = { "\000\000\000\001", 8, gSfAppIdNcp},
}
...
function clientSuccess(context)
    ...
    gDetector:client_addApp(appServiceId, appTypeId, appProductId, "", gSfAppIdNcp);
