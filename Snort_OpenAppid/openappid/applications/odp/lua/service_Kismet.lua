...
--]]
--[[
detection_name: Kismet
version: 5
description: Communication between network sniffer clients and a GUI server.
--]]
...
function DetectorValidator()
    ...
    if (size >= 14 and (gDetector:memcmp(gPatterns.server_resp[1], #gPatterns.server_resp[1], gPatterns.server_resp[2]) == 0)) then
        DC.printf('%s: got a server_resp packet\n', gServiceName)
