...
gPatterns = {
    splunk_cooked = {'--splunk-cooked-mode-v3--', 0, gSfAppIdSplunk},
}


gFastPatterns = {
	{DC.ipproto.tcp, gPatterns.splunk_cooked},
}
...
function clientSuccess(context)
    ...
    gDetector:client_addApp(appServiceId, appTypeId, appProductId, "v3", gSfAppIdSplunk)
...
function client_init( detectorInstance, configOptions)
	...
	appTypeId = 23
	appProductId = 256
	appServiceId = 20139 -- wireshark says the service is SMPP, sounds good to me
...
function client_validate()
    ...
    DC.printf ('Splunk Client packetCount %d dir %d, size %d\n', context.packetCount, dir, size)
