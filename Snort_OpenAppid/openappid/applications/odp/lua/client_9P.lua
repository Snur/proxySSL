...
--[[
detection_name: 9P
description: Plan 9 systems network protocol.
--]]
...
function clientSuccess(context)
    ...
    gDetector:client_addApp(appServiceId, appTypeId, appProductId, "", gSfAppId9p);
...
function client_validate()
	...
	then
		matched, rawSize = gDetector:getPcreGroups("(....)\100........9P", 0)
		if (matched) then
			realSize = DC.reverseBinaryStringToNumber(rawSize, 4)
