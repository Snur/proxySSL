...
--]]
--[[
detection_name: Songsari
description: Korean webportal for Online and download media files.
--]]
...
gSfAppIdSongsari = 2876

gPatterns = {
	pattern1 = {"\018\039\031\000\204\000\000\000\050\049\052\055", 0, gSfAppIdSongsari},
}
...
gUrlPatternList = {
   ...
   --Songsari 
    { 0, 0, 0, 1337, 22, "songsari.org", "/", "http:", "", 2876},
    { 0, 0, 0, 1337, 22, "songsari.com", "/", "http:", "", 2876},
}
...
function clientSuccess(context)
    ...
    gDetector:client_addApp(appServiceId, appTypeId, appProductId, "", gSfAppIdSongsari);
...
function client_init( detectorInstance, configOptions)
	...
	for i,v in ipairs(gAppRegistry) do
     ...
     gDetector:addHttpPattern(2, 5, 0, 441, 20, 0, 0, 'Songsari', 2876, 1);
...
function client_validate()
	...
	--signing in (can't detect downloads with Songsari client as HTTP masks)
