...
--]]
--[[
detection_name: Yahoo! Voice
version: 2
description: Yahoo!'s voice chat client.
--]]
...
function DetectorInit( detectorInstance)
    ...
    gDetector:addHttpPattern(2, 5, 0, 65, 11, 0, 0, 'Yahoo Voice', 926, 1);
   
    -- Functionality to include SIP useragent
