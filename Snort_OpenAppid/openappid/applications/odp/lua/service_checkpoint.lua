...
gServiceId = 20046
gServiceName = 'checkpoint'

--port based detection - needed when not using CSD tables
    --{DC.ipproto.udp, 3478},
gPorts = {
    {DC.ipproto.tcp, 18190},
    {DC.ipproto.tcp, 18191},
}
...
function serviceSuccess(context)
    ...
    if ((not flowFlag) or (flowFlag == 0)) then
        gDetector:addService(gServiceId, "Checkpoint", "", 74)
    end
...
function DetectorValidator()
    ...
    if (dir == 1 and (srcPort == 18190 or srcPort == 18191)) then 
