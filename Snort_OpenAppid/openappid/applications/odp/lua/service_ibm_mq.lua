...
--]]
--[[
detection_name: WebSphere MQ
version: 4
description: Interprocess communication in a distributed environment.
--]]
...
function serviceSuccess(context)
    ...
    if ((not flowFlag) or (flowFlag == 0)) then
        gDetector:addService(gServiceId, "IBM", "", 906)
    end
...
function DetectorValidator()
    ...
    if (dir == 1 and srcPort == 1414) then 
