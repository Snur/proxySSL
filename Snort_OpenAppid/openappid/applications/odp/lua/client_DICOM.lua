...
--]]
--[[
detection_name: DICOM
description: Medical imaging standards for storing,printing and transmitting.
--]]
...
gPatterns = {
    tcpPattern = {'\068\073\067\079\077', 0 , gSfAppIdDICOM},
}
...
function client_validate()
    ...
    DC.printf ('DICOM packetCount %d dir %d, size %d\n', context.packetCount, dir, size)
    if ( dstPort == 8780  ) then
      	DC.printf("DICOM matched it\n")
