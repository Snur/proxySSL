...
--]]
--[[
detection_name: Ganglia
version: 6
description: Monitors distributed computing systems.
--]]
...
function serviceSuccess(context)
    ...
    if ((not flowFlag) or (flowFlag == 0)) then
        gDetector:addService(gServiceId, "Ganglia", "", 171)
    end
...
function DetectorValidator()
    ...
    if (dir == 1 and (srcPort == 8649 or srcPort == 8652 or srcPort == 28650)) then 
