...
--]]
--[[
detection_name: eDonkey
version: 3
description: A peer to peer file sharing network.
--]]
...
gPatterns = {
    byte = { "\227", 0, gSfAppIdEDonkey},
    hello = { "\001", 5, gSfAppIdEDonkey},
}

gFastPatterns = {
    {DC.ipproto.tcp, gPatterns.byte},
    {DC.ipproto.tcp, gPatterns.hello},
}
...
function clientSuccess(context)
    ...
    gDetector:client_addApp(appServiceId, appTypeId, appProductId, "", gSfAppIdEDonkey);
