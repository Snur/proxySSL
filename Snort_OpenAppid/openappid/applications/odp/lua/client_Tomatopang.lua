...
--]]
--[[
detection_name: Tomatopang
description: Korean Peer to Peer file-sharing application.
--]]
...
gSfAppIdTomatopang = 2943

gPatterns = {
    pattern = {"\254\255\255\255", 3, gSfAppIdTomatopang},
}
...
function clientSuccess(context)
    ...
    gDetector:client_addApp(appServiceId, appTypeId, appProductId, "", gSfAppIdTomatopang);
...
function client_validate()
    ...
    if  (size >= 15) and
        ((gDetector:memcmp("\007\001\000\000\000", 5, 10) == 0))
    then
