...
--]]
--[[
detection_name: TURN Client
version: 2
description: A TURN channel client.
--]]
...
function clientSuccess(context)
    ...
    gDetector:client_addApp(appServiceId, appTypeId, appProductId, "", gSfAppIdTURNClient)
...
function client_validate()
    ...
    DC.printf ('TURN Client packetCount %d dir %d, size %d\n', context.packetCount, dir, size)
