...
function DetectorInit(detectorInstance)
    ...
    if (gDetector.CHPCreateApp and gDetector.CHPAddAction) then
        gDetector:CHPCreateApp(629, 6, 0);
        gDetector:CHPAddAction(629, 1, 2, "facebook.com", 1, "");
        gDetector:CHPAddAction(629, 0, 3, "/login.php", 12, "");
        gDetector:CHPAddAction(629, 0, 5, "email=", 2, "&");
    end
    return gDetector
end
