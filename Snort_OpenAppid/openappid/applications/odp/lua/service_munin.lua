...
--]]
--[[
detection_name: Munin
version: 3
description: Munin networked resource monitoring tool
--]]
...
gPatterns = {       
    pattern1          = {'# munin node at ', 0, gSfAppId},
}
...
function DetectorValidator()
    ...
    if (size >= #headBanner and (gDetector:memcmp(headBanner, #headBanner, 0) == 0)) then 
